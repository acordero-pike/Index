       ...
       objectStore.openCursor().onsuccess = function(e) {
            ...
            if(cursor) {
             ...
             else if(fecha===dd[0])
             {
                ...
                btnEliminar.onclick = () => confirmaciondtl(id);
                ...
                btnEditar.onclick = () => confirmacionedt(cursor.value);
...
function confirmacionedt(cursor)
{

    
     var pregunta = 'Seguro que desea Editar?';
        var respuesta= confirm(pregunta);
        if(respuesta)
        {
             cargarEdicion(cursor);  
            alert('Cita cargada Exitosamente');
        }else
        {
alert('Cancelacion Exitosa');
        }
